...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    description: `Professional apartment inspection for ${uni.name} students. Verify off-campus housing near ${uni.fullName} before you sign. Avoid scams. Starting at $50.`,
