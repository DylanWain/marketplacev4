...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    description: `Get apartments, houses, cars, furniture, and marketplace items inspected in ${city}, ${state}. Local inspectors deliver 50+ photos, HD video, FaceTime tours, and detailed reports. Starting at $50.`,
    keywords: [
      ...
      <main>
        ...
        <section className="py-24 gradient-cta relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center relative z-10">
            ...
            <Link href="/book" className="btn-primary text-lg px-10 py-5">Book Inspection — $50</Link>
          </div>
        </section>
      </main>
