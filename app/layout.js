...
export const metadata = {
  ...
  description: 'Get apartments, cars, furniture, and marketplace items inspected before you buy. Local inspectors in NYC and Southern California deliver 50+ photos, HD video, and detailed reports. Starting at $50.',
  keywords: [
  ...
  twitter: {
    ...
    title: 'DibbyTour | See It Before You Sign',
    description: 'Local inspectors verify apartments, cars, furniture & marketplace items. Starting at $50.',
    images: ['/og-image.jpg'],
    creator: '@dibbytour',
  },
  robots: {
    ...
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'Standard inspections start at $50 and include 50+ photos, HD video walkthrough, 15-minute FaceTime call, and a written report. Complete package is $75 with extended features.',
          },
        },
        {
          '@type': 'Question',
