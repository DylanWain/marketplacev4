...
const InternationalStudentVerification = () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "If we determine the listing is fraudulent, we notify you immediately so you don't send money. We provide documentation of the scam and advice on reporting it. This $49-89 investment could save you from losing $2,000+ to scammers."
    },
    {
