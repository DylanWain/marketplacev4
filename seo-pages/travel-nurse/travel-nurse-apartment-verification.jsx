...
const TravelNurseVerification = () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "Absolutely. Many travel nurses use our service for every new assignment. At $49-79 per verification, it's cheap insurance compared to showing up to a nightmare or non-existent apartment. Some nurses book verifications for their top 2-3 choices before deciding."
    },
    {
