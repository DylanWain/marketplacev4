...
function generateCityServiceDescription(service, city) {
  ...
  return `Professional ${serviceName} service in ${cityName}. Local inspectors deliver 50+ photos, HD video walkthrough, and detailed condition report within 24 hours. Starting at $50.`;
}
